...
vllm_extension_sources = [
    ...
    "csrc/quantization/exl2/q_matrix.cu",
    "csrc/quantization/exl2/q_gemm_exl2.cu",
...
if _is_cuda():
    ...
    vllm_extension_sources.append("csrc/quantization/marlin/marlin_cuda_kernel_zero.cu")
